        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:100%; max-width:600px; margin:0 auto; background-color:${C.bg};">
          ...
          <tr>
            <td class="bh-pad" style="padding:8px 0 28px;">
              <a href="{{ .SiteURL }}" style="display:inline-block; text-decoration:none; letter-spacing:0.5px;">
                <img src="{{ .SiteURL }}/images/logo/isotipo-lime.png" alt="" width="26" height="24" style="display:inline-block; vertical-align:middle; border:0; margin-right:9px;">
                <span style="font-family:${FONT_DISPLAY}; font-weight:900; font-size:22px; line-height:1; text-transform:uppercase; color:${C.lime}; vertical-align:middle;">&#39;BALLERS</span><span style="font-family:${FONT_DISPLAY}; font-weight:900; font-size:22px; line-height:1; text-transform:uppercase; color:${C.fg1}; vertical-align:middle;">HUB</span>
              </a>
            </td>
          </tr>
