<!--
====================================================================
CORNERSTONE POST #2 — cluster: career_guidance
VERSIÓN MEJORADA POR EL OWNER (2026-05-28). Reemplaza el draft base.
El agente agregó los links markdown a los portfolios reales (el owner
los había dejado como texto plano) para activar el flywheel SEO.
====================================================================
-->

# METADATOS

- **Título**: Qué buscan los scouts cuando miran el perfil de un futbolista
- **Descripción meta**: Qué mira un scout al evaluar a un futbolista: contexto, video, trayectoria, datos, actitud y presentación profesional. Guía con ejemplos reales.
- **Cluster**: `career_guidance`
- **Tags**: `scouting`, `scouts`, `reclutamiento`, `perfil profesional`, `jugadores`, `carrera deportiva`
- **Hero image sugerida**: imagen horizontal de un scout, entrenador o analista observando un partido desde la tribuna, tomando notas o revisando un perfil en una laptop/tablet.
- **Slug**: `que-buscan-los-scouts-perfil-futbolista`

---

# Qué buscan los scouts cuando miran el perfil de un futbolista
...
En un perfil como el de [Federico Sarra](/federico-sarra), por ejemplo, la presentación como central/lateral derecho no debería leerse solo como dos posiciones. Para un scout, eso puede representar una solución práctica: un defensor capaz de cubrir más de una zona de la línea defensiva. Pero esa versatilidad funciona porque está dentro de un marco lógico. No es una lista infinita de puestos; es una variante creíble dentro del mismo perfil competitivo.

Con un arquero como [Mateo Germani](/mateo-germani), en cambio, la lectura es diferente. La posición no necesita tanta explicación nominal, porque el puesto ya es específico. Lo importante es que el perfil ayude a evaluar otras cosas: actualidad, contexto, video, seguridad, continuidad, referencias y tipo de acciones que muestra.
...
Un recorrido como el de [Julián Berardinelli](/julian-berardinelli), por ejemplo, no se resume únicamente en el club actual. Para evaluarlo bien, importa entender que hubo experiencias en diferentes países y contextos competitivos. En esos casos, el portfolio cumple una función importante: ordenar una historia que, contada por mensaje, podría quedar demasiado larga o fragmentada.
...
Crear un perfil que los scouts puedan evaluar en segundos → `/pricing`
