    ...
    <main className="mx-auto max-w-5xl px-4 py-8 space-y-8">
      ...
      <div className="flex flex-col md:flex-row gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-4">
            {agency.websiteUrl && (
              <a
                ...
                className="inline-flex items-center justify-center h-10 w-10 rounded-full bg-neutral-900 border border-neutral-800 text-neutral-400 hover:text-white hover:border-white transition-colors"
              >
            ...
            {agency.instagramUrl && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center h-10 w-10 rounded-full bg-neutral-900 border border-neutral-800 text-neutral-400 hover:text-pink-500 hover:border-pink-500 transition-colors"
              >
            ...
            {agency.twitterUrl && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center h-10 w-10 rounded-full bg-neutral-900 border border-neutral-800 text-neutral-400 hover:text-sky-500 hover:border-sky-500 transition-colors"
              >
            ...
            {agency.linkedinUrl && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center h-10 w-10 rounded-full bg-neutral-900 border border-neutral-800 text-neutral-400 hover:text-blue-600 hover:border-blue-600 transition-colors"
              >
          ...
          {isVisible("about") && agency.description && (
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              {players.map((player) => (
                <Link
                  key={player.id}
                  href={`/${player.slug}`}
                  className="group relative overflow-hidden rounded-xl border border-neutral-800 bg-neutral-900/50 transition-all hover:bg-neutral-800 hover:border-neutral-700 flex flex-col h-full"
                >
                  <div className="aspect-[4/3] w-full bg-neutral-950 overflow-hidden relative">
                    ...
                    <div className="absolute bottom-3 left-3 right-3 flex justify-between items-end">
                      <div>
                        <h3 className="font-semibold text-white truncate text-shadow-sm">
                          {player.fullName}
                        </h3>
