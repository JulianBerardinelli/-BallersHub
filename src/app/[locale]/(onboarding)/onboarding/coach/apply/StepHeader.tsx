    ...
    <div className="space-y-5">
      <div className="space-y-2">
        <span className="inline-flex items-center rounded-bh-pill border border-bh-fg-4 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.12em] text-bh-fg-3">
          {t("coachApply.header.badge", { step: activeStep })}
        </span>
        <h1 className="font-bh-display text-3xl font-bold uppercase leading-[1.05] tracking-[-0.005em] text-bh-fg-1 md:text-4xl">
          {t("coachApply.header.title")}{" "}
          <span className="text-bh-lime">{t("coachApply.header.titleHighlight")}</span>
        </h1>
      </div>

      <ol className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        {[
          { n: 1, title: t("coachApply.header.step1Title"), sub: t("coachApply.header.step1Sub") },
          { n: 2, title: t("coachApply.header.step2Title"), sub: t("coachApply.header.step2Sub") },
          { n: 3, title: t("coachApply.header.step3Title"), sub: t("coachApply.header.step3Sub") },
        ].map((s) => {
