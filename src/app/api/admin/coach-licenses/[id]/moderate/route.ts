// Moderates a single coach_licenses credential (pre-moderation: pending →
// approved / rejected). Approving publishes the credential on the portfolio;
// rejecting keeps it for the coach to fix, with a reason.
...
export async function POST(req: Request, ctx: { params: Params }) {
  ...
  revalidatePath("/admin/coach-licenses");
