-- 0018 recreated the player_dashboard_state view from a stale template that
-- omitted profile_transfermarkt_url. The data-provider requires this column,
-- so any read of the view fails with 42703 (undefined_column). Add it back.
