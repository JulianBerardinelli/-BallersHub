...
export default function HeaderLocaleSwitcher({
  ...
  return (
    <div className="relative shrink-0">
      ...
      {open ? (
        <div className="absolute right-0 top-full z-20 mt-2 min-w-[170px] overflow-hidden rounded-2xl border border-white/10 bg-black/80 p-1 shadow-[0_20px_40px_rgba(0,0,0,0.5)] backdrop-blur-xl">
          {locales.map((loc) => {
