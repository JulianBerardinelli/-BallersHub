// /agencies — closing call-to-action. Mirrors the home CallToActionBanner but
// with agency-focused copy.
      ...
      <div className="relative z-10 flex flex-col items-start gap-6 md:flex-row md:items-center md:justify-between">
        <div className="space-y-3">
          ...
          <h2 className="font-bh-display text-3xl font-black uppercase leading-[1.05] tracking-[-0.005em] text-bh-fg-1 md:text-4xl">
            ¿Representás jugadores?
          </h2>
          <p className="max-w-[520px] text-sm leading-[1.6] text-bh-fg-3">
            Creá tu agencia en {"'BallersHub"}, cargá tu cartera y empezá a
            recibir visibilidad de clubes y scouts.
          </p>
        </div>
        <Link
          href="/auth/sign-up"
